...
- justify-content has no effect on this element since it doesn't define a flexbox layout (try adding display:flex)
- align-content has no effect on this element since it doesn't define a flexbox layout (try adding display:flex)
- align-items has no effect on this element since it doesn't define a flexbox layout (try adding display:flex)
- align-self has no effect on this element since it doesn't define a flexbox layout (try adding display:flex)
- flex has no effect on this element since it doesn't define a flexbox layout (try adding display:flex)
- flex-basis has no effect on this element since it doesn't define a flexbox layout (try adding display:flex)
- flex-grow has no effect on this element since it doesn't define a flexbox layout (try adding display:flex)
- flex-shrink has no effect on this element since it doesn't define a flexbox layout (try adding display:flex)
- flex-wrap has no effect on this element since it doesn't define a flexbox layout (try adding display:flex)
- order has no effect on this element since it doesn't define a flexbox layout (try adding display:flex)
